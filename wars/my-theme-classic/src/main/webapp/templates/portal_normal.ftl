...
<div class="container-fluid" id="wrapper">
	<#if show_header>
		<header id="banner">
				...
				<div class="container user-personal-bar">
					<div class="align-items-center autofit-row">
						<a class="${logo_css_class} align-items-center d-md-inline-flex d-sm-none d-none logo-md" href="${site_default_url}" title="<@liferay.language_format arguments="" key="go-to-x" />">
							...
							<#if show_site_name>
								<h1 style="font-family: serif;text-shadow: 1px 1px 1px blue;color: #da251c">${site_name}</h1>
							</#if>
						</a>
			...
			<div class="navbar navbar-classic navbar-expand-md navbar-light pb-3" style="background-color: #1717e6cc;">
				<div class="container">
				...
				<div class="container">
					<div class="row">
						<div class="col-md-12 text-center text-md-left">
							...
							<a class="text-white" href="#" rel="external">ANNN</a>
						</div>
					</div>
				</div>
			</footer>
