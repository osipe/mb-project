...
<aui:form name="frm">
<h3 style="text-align: center;">TỔNG HỢP SAO KÊ DƯ NỢ CỘNG TÁC VIÊN</h3>
...
<portlet:resourceURL var="inSaoKeDuNoCTVURL" id="inSaoKeDuNoCTV"></portlet:resourceURL>
