	...
	<div id="idSearchAdvance" class="collapse">
		<table class="info table-pa5 aui-w100">
			<tr>
				...
				<td>
					<aui:input name="maSearch" class="input-text" label="Mã">
					</aui:input>
				</td>
				<td>
			...
			<tr>
				<td colspan="3">
					<aui:input name="ghiChuSearch" class="input-text" label="Ghi chú">
					</aui:input>
				</td>
			</tr>
			<tr>
...
AUI().ready(['aui-base'], function(A) {
	...
	Liferay.provide(window,'search', function(){
		...
		var data = {
			...
			'<portlet:namespace/>ghiChuSearch' : A.one('#<portlet:namespace />ghiChuSearch').val(),
	...
	Liferay.provide(window,'openDialog', function(){
		Liferay.Util.openWindow({
			...
			title : 'Thêm danh mục loại tài sản',
			uri : '${addURL}'
		});
	});
