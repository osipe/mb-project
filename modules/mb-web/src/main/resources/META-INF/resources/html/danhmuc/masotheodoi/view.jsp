...
<portlet:renderURL var="searchURL"
	...
	<portlet:param name="mvcPath" value="/html/danhmuc/masotheodoi/data.jsp" />
</portlet:renderURL>
<aui:form name="frm">
	...
	<div id="idSearchAdvance" class="collapse">
		<table class="info table-pa5 aui-w100">
			<tr>
				...
				<td>
					<aui:input name="dienGiaiSearch" class="input-text" label="Diễn giải">
					</aui:input>
				</td>
				<td>
...
AUI().ready(['aui-base'], function(A) {
	...
	Liferay.provide(window,'search', function(){
		...
		var data = {
        	...
        	'<portlet:namespace/>dienGiaiSearch' : A.one('#<portlet:namespace />dienGiaiSearch').val(),
	...
	Liferay.provide(window,'thongBao', function(){
		toastr.success('Thêm mã số theo dõi thành công', 'Thông báo!');
	});
	search();
});
</aui:script>