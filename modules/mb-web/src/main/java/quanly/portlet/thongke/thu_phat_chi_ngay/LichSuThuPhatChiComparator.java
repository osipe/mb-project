...
public class LichSuThuPhatChiComparator extends OrderByComparator {
	...
	public LichSuThuPhatChiComparator() {
		this("createdate", false);
	}

	public LichSuThuPhatChiComparator(String field, boolean ascending) {
