...
public class LichSuTaiKhoanDauComparator extends OrderByComparator {
	...
	public LichSuTaiKhoanDauComparator() {
		this("createdate", false);
	}

	public LichSuTaiKhoanDauComparator(String field, boolean ascending) {
