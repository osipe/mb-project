...
public class TaiSanTheChapComparator extends OrderByComparator {
	...
	public TaiSanTheChapComparator() {
		this("createdate", false);
	}

	public TaiSanTheChapComparator(String field, boolean ascending) {
