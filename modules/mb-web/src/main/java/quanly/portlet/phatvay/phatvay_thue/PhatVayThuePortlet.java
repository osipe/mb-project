package quanly.portlet.phatvay.phatvay_thue;
...
@Component(immediate = true, property = { "com.liferay.portlet.display-category=category.sample",
		...
		"javax.portlet.init-param.view-template=/html/phatvay/phatvay_thue/view.jsp",
		"javax.portlet.display-name=" + QuanlyPortletKeys.phatVayThue, "javax.portlet.name=" + QuanlyPortletKeys.phatVayThue,
...
public class PhatVayThuePortlet extends MVCPortlet {
	@Override
