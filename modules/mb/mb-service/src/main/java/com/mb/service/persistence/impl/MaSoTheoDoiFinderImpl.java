 ...
 * @generated
 */
@Component(service = MaSoTheoDoiFinder.class)
public class MaSoTheoDoiFinderImpl extends MaSoThuChiFinderBaseImpl implements MaSoTheoDoiFinder {
	@ServiceReference(type = CustomSQL.class)
	private CustomSQL _customSQL;

	public static final String FIND_BASE = MaSoTheoDoiFinder.class.getName() + ".findBase";
	public static final String COUNT_BASE = MaSoTheoDoiFinder.class.getName() + ".countBase";
	...
	public List<MaSoTheoDoi> findBase(String ma, String dienGiai,int hoatDong, int start, int end,
		...
		try {
			...
			q.addEntity("MaSoTheoDoi", MaSoTheoDoiImpl.class);
			...
			return (List<MaSoTheoDoi>) QueryUtil.list(q, getDialect(), start, end);
		} catch (Exception e) {
			e.printStackTrace();
