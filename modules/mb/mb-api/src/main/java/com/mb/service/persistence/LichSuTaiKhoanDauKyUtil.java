...
/**
 * The persistence utility for the lich su tai khoan dau ky service. This utility wraps <code>com.mb.service.persistence.impl.LichSuTaiKhoanDauKyPersistenceImpl</code> and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
 ...
 * @see LichSuTaiKhoanDauKyPersistence
 * @generated
 */
@ProviderType
public class LichSuTaiKhoanDauKyUtil {
	 ...
	 */
	public static void clearCache(LichSuTaiKhoanDauKy lichSuTaiKhoanDauKy) {
		getPersistence().clearCache(lichSuTaiKhoanDauKy);
	}
	 ...
	 */
	public static Map<Serializable, LichSuTaiKhoanDauKy> fetchByPrimaryKeys(
	 ...
	 */
	public static List<LichSuTaiKhoanDauKy> findWithDynamicQuery(
	 ...
	 */
	public static LichSuTaiKhoanDauKy update(
		LichSuTaiKhoanDauKy lichSuTaiKhoanDauKy) {

		return getPersistence().update(lichSuTaiKhoanDauKy);
	}
	...
	public static LichSuTaiKhoanDauKy update(
		...
		return getPersistence().update(lichSuTaiKhoanDauKy, serviceContext);
	}
	 ...
	 */
	public static LichSuTaiKhoanDauKy findByTaiKhoanDoiUngId_Nam_Thang(
			long taiKhoanDoiUngId, int nam, int thang)
		throws com.mb.exception.NoSuchLichSuTaiKhoanDauKyException {

		return getPersistence().findByTaiKhoanDoiUngId_Nam_Thang(
			taiKhoanDoiUngId, nam, thang);
	}
	 ...
	 */
	public static LichSuTaiKhoanDauKy fetchByTaiKhoanDoiUngId_Nam_Thang(
		long taiKhoanDoiUngId, int nam, int thang) {

		return getPersistence().fetchByTaiKhoanDoiUngId_Nam_Thang(
			taiKhoanDoiUngId, nam, thang);
	}
	...
	public static LichSuTaiKhoanDauKy fetchByTaiKhoanDoiUngId_Nam_Thang(
		...
		return getPersistence().fetchByTaiKhoanDoiUngId_Nam_Thang(
			taiKhoanDoiUngId, nam, thang, retrieveFromCache);
	}
	 ...
	 */
	public static LichSuTaiKhoanDauKy removeByTaiKhoanDoiUngId_Nam_Thang(
			long taiKhoanDoiUngId, int nam, int thang)
		throws com.mb.exception.NoSuchLichSuTaiKhoanDauKyException {

		return getPersistence().removeByTaiKhoanDoiUngId_Nam_Thang(
			taiKhoanDoiUngId, nam, thang);
	}
	 ...
	 */
	public static int countByTaiKhoanDoiUngId_Nam_Thang(
		long taiKhoanDoiUngId, int nam, int thang) {

		return getPersistence().countByTaiKhoanDoiUngId_Nam_Thang(
			taiKhoanDoiUngId, nam, thang);
	}
	 ...
	 */
	public static List<LichSuTaiKhoanDauKy> findByTaiKhoanDoiUngId(
		long taiKhoanDoiUngId) {

		return getPersistence().findByTaiKhoanDoiUngId(taiKhoanDoiUngId);
	}
	...
	public static List<LichSuTaiKhoanDauKy> findByTaiKhoanDoiUngId(
		...
		return getPersistence().findByTaiKhoanDoiUngId(
			taiKhoanDoiUngId, start, end);
	}
	...
	public static List<LichSuTaiKhoanDauKy> findByTaiKhoanDoiUngId(
		...
		return getPersistence().findByTaiKhoanDoiUngId(
			taiKhoanDoiUngId, start, end, orderByComparator, retrieveFromCache);
	}
	 ...
	 * @throws NoSuchLichSuTaiKhoanDauKyException if a matching lich su tai khoan dau ky could not be found
	 */
	public static LichSuTaiKhoanDauKy findByTaiKhoanDoiUngId_First(
			long taiKhoanDoiUngId,
			OrderByComparator<LichSuTaiKhoanDauKy> orderByComparator)
		throws com.mb.exception.NoSuchLichSuTaiKhoanDauKyException {

		return getPersistence().findByTaiKhoanDoiUngId_First(
	 ...
	 */
	public static LichSuTaiKhoanDauKy fetchByTaiKhoanDoiUngId_First(
		long taiKhoanDoiUngId,
		OrderByComparator<LichSuTaiKhoanDauKy> orderByComparator) {

		return getPersistence().fetchByTaiKhoanDoiUngId_First(
			taiKhoanDoiUngId, orderByComparator);
	}
	 ...
	 * @throws NoSuchLichSuTaiKhoanDauKyException if a matching lich su tai khoan dau ky could not be found
	 */
	public static LichSuTaiKhoanDauKy findByTaiKhoanDoiUngId_Last(
			long taiKhoanDoiUngId,
			OrderByComparator<LichSuTaiKhoanDauKy> orderByComparator)
		throws com.mb.exception.NoSuchLichSuTaiKhoanDauKyException {

		return getPersistence().findByTaiKhoanDoiUngId_Last(
			taiKhoanDoiUngId, orderByComparator);
	}
	 ...
	 */
	public static LichSuTaiKhoanDauKy fetchByTaiKhoanDoiUngId_Last(
		long taiKhoanDoiUngId,
		OrderByComparator<LichSuTaiKhoanDauKy> orderByComparator) {

		return getPersistence().fetchByTaiKhoanDoiUngId_Last(
			taiKhoanDoiUngId, orderByComparator);
	}
	 ...
	 */
	public static LichSuTaiKhoanDauKy[] findByTaiKhoanDoiUngId_PrevAndNext(
			long lichSuTaiKhoanDauKyId, long taiKhoanDoiUngId,
			OrderByComparator<LichSuTaiKhoanDauKy> orderByComparator)
		throws com.mb.exception.NoSuchLichSuTaiKhoanDauKyException {

		return getPersistence().findByTaiKhoanDoiUngId_PrevAndNext(
			lichSuTaiKhoanDauKyId, taiKhoanDoiUngId, orderByComparator);
	}
	 ...
	 * @param taiKhoanDoiUngId the tai khoan doi ung ID
	 */
	public static void removeByTaiKhoanDoiUngId(long taiKhoanDoiUngId) {
		getPersistence().removeByTaiKhoanDoiUngId(taiKhoanDoiUngId);
	}
	 ...
	 * @return the number of matching lich su tai khoan dau kies
	 */
	public static int countByTaiKhoanDoiUngId(long taiKhoanDoiUngId) {
		return getPersistence().countByTaiKhoanDoiUngId(taiKhoanDoiUngId);
	}
	 ...
	 */
	public static void cacheResult(LichSuTaiKhoanDauKy lichSuTaiKhoanDauKy) {
		getPersistence().cacheResult(lichSuTaiKhoanDauKy);
	}
	...
	public static void cacheResult(
		List<LichSuTaiKhoanDauKy> lichSuTaiKhoanDauKies) {

		getPersistence().cacheResult(lichSuTaiKhoanDauKies);
	}
	 ...
	 */
	public static LichSuTaiKhoanDauKy create(long lichSuTaiKhoanDauKyId) {
		return getPersistence().create(lichSuTaiKhoanDauKyId);
	}
	 ...
	 * @throws NoSuchLichSuTaiKhoanDauKyException if a lich su tai khoan dau ky with the primary key could not be found
	 */
	public static LichSuTaiKhoanDauKy remove(long lichSuTaiKhoanDauKyId)
		throws com.mb.exception.NoSuchLichSuTaiKhoanDauKyException {

		return getPersistence().remove(lichSuTaiKhoanDauKyId);
	}

	public static LichSuTaiKhoanDauKy updateImpl(
		LichSuTaiKhoanDauKy lichSuTaiKhoanDauKy) {

		return getPersistence().updateImpl(lichSuTaiKhoanDauKy);
	}
	 ...
	 * @throws NoSuchLichSuTaiKhoanDauKyException if a lich su tai khoan dau ky with the primary key could not be found
	 */
	public static LichSuTaiKhoanDauKy findByPrimaryKey(
			long lichSuTaiKhoanDauKyId)
		throws com.mb.exception.NoSuchLichSuTaiKhoanDauKyException {

		return getPersistence().findByPrimaryKey(lichSuTaiKhoanDauKyId);
	}
	 ...
	 */
	public static LichSuTaiKhoanDauKy fetchByPrimaryKey(
		long lichSuTaiKhoanDauKyId) {

		return getPersistence().fetchByPrimaryKey(lichSuTaiKhoanDauKyId);
	}
	 ...
	 */
	public static List<LichSuTaiKhoanDauKy> findAll() {
	 ...
	 */
	public static List<LichSuTaiKhoanDauKy> findAll(int start, int end) {
	...
	public static LichSuTaiKhoanDauKyPersistence getPersistence() {
	...
	static {
		Bundle bundle = FrameworkUtil.getBundle(
			LichSuTaiKhoanDauKyPersistence.class);

		ServiceTracker
			<LichSuTaiKhoanDauKyPersistence, LichSuTaiKhoanDauKyPersistence>
				serviceTracker =
					new ServiceTracker
						<LichSuTaiKhoanDauKyPersistence,
						 LichSuTaiKhoanDauKyPersistence>(
							 bundle.getBundleContext(),
							 LichSuTaiKhoanDauKyPersistence.class, null);
