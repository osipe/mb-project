 ...
 * <code>com.mb.service.impl.KhachHangLocalServiceImpl</code> and
...
public class KhachHangLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.mb.service.impl.KhachHangLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static com.mb.model.KhachHang addKhachHang(
	...
	public static com.mb.model.KhachHang addKhachHang(
		...
		return getService().addKhachHang(KhachHang, serviceContext);
	}

	public static com.mb.model.KhachHang addOrUpdateKhachHang(
			com.mb.model.KhachHang KhachHang,
			com.liferay.portal.kernel.service.ServiceContext serviceContext)
		throws com.liferay.portal.kernel.exception.PortalException,
			   com.liferay.portal.kernel.exception.SystemException,
		...
		return getService().addOrUpdateKhachHang(KhachHang, serviceContext);
	}
	 ...
	 */
	public static com.mb.model.KhachHang createKhachHang(long khachHangId) {
	 ...
	 */
	public static com.mb.model.KhachHang deleteKhachHang(
		com.mb.model.KhachHang khachHang) {
	 ...
	 */
	public static com.mb.model.KhachHang deleteKhachHang(long khachHangId)
		throws com.liferay.portal.kernel.exception.PortalException {
	...
	public static com.mb.model.KhachHang fetchByMa(String ma)
		throws com.liferay.portal.kernel.exception.SystemException {

		return getService().fetchByMa(ma);
	}

	public static com.mb.model.KhachHang fetchBySoCMND(String soCMND)
		throws com.liferay.portal.kernel.exception.SystemException {

		return getService().fetchBySoCMND(soCMND);
	}

	public static com.mb.model.KhachHang fetchKhachHang(long khachHangId) {
		return getService().fetchKhachHang(khachHangId);
	}

	public static java.util.List<com.mb.model.KhachHang> findBase(
			String ma, String maCTV, String hoTen, String soCMND, String diaChi,
	...
	public static java.util.List<com.mb.model.KhachHang> findByMaCTV(
			String maCTV)
		throws com.liferay.portal.kernel.exception.SystemException {
	 ...
	 * @throws PortalException if a khach hang with the primary key could not be found
	 */
	public static com.mb.model.KhachHang getKhachHang(long khachHangId)
		throws com.liferay.portal.kernel.exception.PortalException {
	 ...
	 */
	public static java.util.List<com.mb.model.KhachHang> getKhachHangs(
		int start, int end) {
	 ...
	 */
	public static com.mb.model.KhachHang updateKhachHang(
		com.mb.model.KhachHang khachHang) {
	...
	public static com.mb.model.KhachHang updateKhachHang(
		...
		return getService().updateKhachHang(KhachHang, serviceContext);
	}
	...
	private static ServiceTracker<KhachHangLocalService, KhachHangLocalService>
		_serviceTracker;

	static {
		Bundle bundle = FrameworkUtil.getBundle(KhachHangLocalService.class);

		ServiceTracker<KhachHangLocalService, KhachHangLocalService>
			serviceTracker =
				new ServiceTracker
					<KhachHangLocalService, KhachHangLocalService>(
						bundle.getBundleContext(), KhachHangLocalService.class,
						null);
