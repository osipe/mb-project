...
public class CongTacVienUtil {
	 ...
	 */
	public static List<CongTacVien> findByChiNhanh_HoatDong(
		long chiNhanhId, Boolean hoatDong) {

		return getPersistence().findByChiNhanh_HoatDong(chiNhanhId, hoatDong);
	}
	...
	public static List<CongTacVien> findByChiNhanh_HoatDong(
		...
		return getPersistence().findByChiNhanh_HoatDong(
			chiNhanhId, hoatDong, start, end);
	}
	 ...
	 * @throws NoSuchCongTacVienException if a matching cong tac vien could not be found
	 */
	public static CongTacVien findByChiNhanh_HoatDong_First(
			long chiNhanhId, Boolean hoatDong,
			OrderByComparator<CongTacVien> orderByComparator)
		throws com.mb.exception.NoSuchCongTacVienException {

		return getPersistence().findByChiNhanh_HoatDong_First(
	 ...
	 */
	public static CongTacVien fetchByChiNhanh_HoatDong_First(
		long chiNhanhId, Boolean hoatDong,
		OrderByComparator<CongTacVien> orderByComparator) {

		return getPersistence().fetchByChiNhanh_HoatDong_First(
			chiNhanhId, hoatDong, orderByComparator);
	}
	 ...
	 * @throws NoSuchCongTacVienException if a matching cong tac vien could not be found
	 */
	public static CongTacVien findByChiNhanh_HoatDong_Last(
			long chiNhanhId, Boolean hoatDong,
			OrderByComparator<CongTacVien> orderByComparator)
		throws com.mb.exception.NoSuchCongTacVienException {

		return getPersistence().findByChiNhanh_HoatDong_Last(
			chiNhanhId, hoatDong, orderByComparator);
	}
	 ...
	 */
	public static CongTacVien fetchByChiNhanh_HoatDong_Last(
		long chiNhanhId, Boolean hoatDong,
		OrderByComparator<CongTacVien> orderByComparator) {

		return getPersistence().fetchByChiNhanh_HoatDong_Last(
			chiNhanhId, hoatDong, orderByComparator);
	}
	 ...
	 */
	public static CongTacVien[] findByChiNhanh_HoatDong_PrevAndNext(
			long congTacVienId, long chiNhanhId, Boolean hoatDong,
			OrderByComparator<CongTacVien> orderByComparator)
		throws com.mb.exception.NoSuchCongTacVienException {

		return getPersistence().findByChiNhanh_HoatDong_PrevAndNext(
			congTacVienId, chiNhanhId, hoatDong, orderByComparator);
	}
	 ...
	 * @param hoatDong the hoat dong
	 */
	public static void removeByChiNhanh_HoatDong(
		long chiNhanhId, Boolean hoatDong) {

		getPersistence().removeByChiNhanh_HoatDong(chiNhanhId, hoatDong);
	}
	 ...
	 * @return the number of matching cong tac viens
	 */
	public static int countByChiNhanh_HoatDong(
		long chiNhanhId, Boolean hoatDong) {

		return getPersistence().countByChiNhanh_HoatDong(chiNhanhId, hoatDong);
	}
	 ...
	 * @return the matching cong tac viens
	 */
	public static List<CongTacVien> findByChiNhanh(long chiNhanhId) {
		return getPersistence().findByChiNhanh(chiNhanhId);
	}
	 ...
	 * @return the range of matching cong tac viens
	 */
	public static List<CongTacVien> findByChiNhanh(
		long chiNhanhId, int start, int end) {

		return getPersistence().findByChiNhanh(chiNhanhId, start, end);
	}
	...
	public static List<CongTacVien> findByChiNhanh(
		...
		return getPersistence().findByChiNhanh(
	...
	public static List<CongTacVien> findByChiNhanh(
		...
		return getPersistence().findByChiNhanh(
			chiNhanhId, start, end, orderByComparator, retrieveFromCache);
	}
	 ...
	 * @throws NoSuchCongTacVienException if a matching cong tac vien could not be found
	 */
	public static CongTacVien findByChiNhanh_First(
			long chiNhanhId, OrderByComparator<CongTacVien> orderByComparator)
		throws com.mb.exception.NoSuchCongTacVienException {

		return getPersistence().findByChiNhanh_First(
	 ...
	 * @return the first matching cong tac vien, or <code>null</code> if a matching cong tac vien could not be found
	 */
	public static CongTacVien fetchByChiNhanh_First(
		long chiNhanhId, OrderByComparator<CongTacVien> orderByComparator) {

		return getPersistence().fetchByChiNhanh_First(
			chiNhanhId, orderByComparator);
	}
	 ...
	 * @throws NoSuchCongTacVienException if a matching cong tac vien could not be found
	 */
	public static CongTacVien findByChiNhanh_Last(
			long chiNhanhId, OrderByComparator<CongTacVien> orderByComparator)
		throws com.mb.exception.NoSuchCongTacVienException {

		return getPersistence().findByChiNhanh_Last(
			chiNhanhId, orderByComparator);
	}
	 ...
	 * @return the last matching cong tac vien, or <code>null</code> if a matching cong tac vien could not be found
	 */
	public static CongTacVien fetchByChiNhanh_Last(
		long chiNhanhId, OrderByComparator<CongTacVien> orderByComparator) {

		return getPersistence().fetchByChiNhanh_Last(
			chiNhanhId, orderByComparator);
	}
	 ...
	 * @throws NoSuchCongTacVienException if a cong tac vien with the primary key could not be found
	 */
	public static CongTacVien[] findByChiNhanh_PrevAndNext(
			long congTacVienId, long chiNhanhId,
			OrderByComparator<CongTacVien> orderByComparator)
		throws com.mb.exception.NoSuchCongTacVienException {

		return getPersistence().findByChiNhanh_PrevAndNext(
			congTacVienId, chiNhanhId, orderByComparator);
	}
	 ...
	 * @param chiNhanhId the chi nhanh ID
	 */
	public static void removeByChiNhanh(long chiNhanhId) {
		getPersistence().removeByChiNhanh(chiNhanhId);
	}
	 ...
	 * @return the number of matching cong tac viens
	 */
	public static int countByChiNhanh(long chiNhanhId) {
		return getPersistence().countByChiNhanh(chiNhanhId);
	}
