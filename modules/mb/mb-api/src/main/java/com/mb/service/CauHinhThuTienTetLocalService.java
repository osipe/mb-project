...
/**
 * Provides the local service interface for CauHinhThuTienTet. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see CauHinhThuTienTetLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface CauHinhThuTienTetLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link CauHinhThuTienTetLocalServiceUtil} to access the cau hinh thu tien tet local service. Add custom service methods to <code>com.mb.service.impl.CauHinhThuTienTetLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	public CauHinhThuTienTet addCauHinhThuTienTet(
	...
	public CauHinhThuTienTet createCauHinhThuTienTet(long cauHinhThuTienTetId);
	...
	public CauHinhThuTienTet deleteCauHinhThuTienTet(
		CauHinhThuTienTet cauHinhThuTienTet);
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public CauHinhThuTienTet deleteCauHinhThuTienTet(long cauHinhThuTienTetId)
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public CauHinhThuTienTet fetchCauHinhThuTienTet(long cauHinhThuTienTetId);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public CauHinhThuTienTet getCauHinhThuTienTet(long cauHinhThuTienTetId)
		throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<CauHinhThuTienTet> getCauHinhThuTienTets(int start, int end);
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public CauHinhThuTienTet updateCauHinhThuTienTet(
		CauHinhThuTienTet cauHinhThuTienTet);
