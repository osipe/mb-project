...
/**
 * Provides the local service interface for QuanLyMaSo. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see QuanLyMaSoLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface QuanLyMaSoLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link QuanLyMaSoLocalServiceUtil} to access the quan ly ma so local service. Add custom service methods to <code>com.mb.service.impl.QuanLyMaSoLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	public QuanLyMaSo addQuanLyMaSo(QuanLyMaSo quanLyMaSo);

	public QuanLyMaSo addQuanLyMaSo(
	...
	public QuanLyMaSo createQuanLyMaSo(long quanLyMaSoId);
	...
	public QuanLyMaSo deleteQuanLyMaSo(long quanLyMaSoId)
		throws PortalException;
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public QuanLyMaSo deleteQuanLyMaSo(QuanLyMaSo quanLyMaSo);
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public QuanLyMaSo fetchQuanLyMaSo(long quanLyMaSoId);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public QuanLyMaSo getQuanLyMaSo(long quanLyMaSoId) throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<QuanLyMaSo> getQuanLyMaSos(int start, int end);
	...
	public QuanLyMaSo tangQuanLyMaSo(String key, ServiceContext serviceContext)
		throws SystemException;
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public QuanLyMaSo updateQuanLyMaSo(QuanLyMaSo quanLyMaSo);

	public QuanLyMaSo updateQuanLyMaSo(
			QuanLyMaSo quanLyMaSo, ServiceContext serviceContext)
		throws SystemException;
