...
/**
 * Provides the local service interface for LaiSuat. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see LaiSuatLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface LaiSuatLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link LaiSuatLocalServiceUtil} to access the lai suat local service. Add custom service methods to <code>com.mb.service.impl.LaiSuatLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	public LaiSuat addLaiSuat(LaiSuat laiSuat);

	public LaiSuat addLaiSuat(LaiSuat LaiSuat, ServiceContext serviceContext)
		throws PortalException, SystemException, TrungLaiSuatException;

	public LaiSuat addOrUpdateLaiSuat(
	...
	public LaiSuat createLaiSuat(long laiSuatId);
	...
	public LaiSuat deleteLaiSuat(LaiSuat laiSuat);
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public LaiSuat deleteLaiSuat(long laiSuatId) throws PortalException;
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public LaiSuat fetchLaiSuat(long laiSuatId);

	public List<LaiSuat> findBase(
			Double soTienVay, Double laiSuat, int thoiHan, int hoatDong,
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public LaiSuat getLaiSuat(long laiSuatId) throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<LaiSuat> getLaiSuats(int start, int end);
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public LaiSuat updateLaiSuat(LaiSuat laiSuat);
