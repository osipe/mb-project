...
/**
 * Provides the local service interface for SoKheUoc. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see SoKheUocLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface SoKheUocLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link SoKheUocLocalServiceUtil} to access the so khe uoc local service. Add custom service methods to <code>com.mb.service.impl.SoKheUocLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	public SoKheUoc addSoKheUoc(SoKheUoc soKheUoc);

	public SoKheUoc addSoKheUoc(
	...
	public SoKheUoc createSoKheUoc(long soKheUocId);
	...
	public SoKheUoc deleteSoKheUoc(long soKheUocId) throws PortalException;
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public SoKheUoc deleteSoKheUoc(SoKheUoc soKheUoc);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public SoKheUoc getSoKheUoc(long soKheUocId) throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<SoKheUoc> getSoKheUocs(int start, int end);
	...
	public SoKheUoc tangSoKheUoc(String cauTruc, ServiceContext serviceContext)
		throws SystemException;
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public SoKheUoc updateSoKheUoc(SoKheUoc soKheUoc);

	public SoKheUoc updateSoKheUoc(
			SoKheUoc soKheUoc, ServiceContext serviceContext)
		throws SystemException;
