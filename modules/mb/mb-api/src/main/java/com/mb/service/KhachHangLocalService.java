...
public interface KhachHangLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link KhachHangLocalServiceUtil} to access the khach hang local service. Add custom service methods to <code>com.mb.service.impl.KhachHangLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	public KhachHang addOrUpdateKhachHang(
			KhachHang KhachHang, ServiceContext serviceContext)
		throws PortalException, SystemException, TrungMaException,
			   TrungSoCMNDException;
	...
	public KhachHang createKhachHang(long khachHangId);
	...
	public KhachHang deleteKhachHang(KhachHang khachHang);
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public KhachHang deleteKhachHang(long khachHangId) throws PortalException;
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public KhachHang fetchKhachHang(long khachHangId);

	public List<KhachHang> findBase(
			String ma, String maCTV, String hoTen, String soCMND, String diaChi,
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public KhachHang getKhachHang(long khachHangId) throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<KhachHang> getKhachHangs(int start, int end);
