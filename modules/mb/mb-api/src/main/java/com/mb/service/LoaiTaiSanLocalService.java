...
/**
 * Provides the local service interface for LoaiTaiSan. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see LoaiTaiSanLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface LoaiTaiSanLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link LoaiTaiSanLocalServiceUtil} to access the loai tai san local service. Add custom service methods to <code>com.mb.service.impl.LoaiTaiSanLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	public LoaiTaiSan addLoaiTaiSan(LoaiTaiSan loaiTaiSan);

	public LoaiTaiSan addLoaiTaiSan(
	...
	public LoaiTaiSan addOrUpdateLoaiTaiSan(
			LoaiTaiSan LoaiTaiSan, ServiceContext serviceContext)
		throws PortalException, SystemException, TrungMaException,
			   TrungSoCMNDException;
	...
	public LoaiTaiSan createLoaiTaiSan(long loaiTaiSanId);
	...
	public LoaiTaiSan deleteLoaiTaiSan(LoaiTaiSan loaiTaiSan);
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public LoaiTaiSan deleteLoaiTaiSan(long loaiTaiSanId)
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public LoaiTaiSan fetchLoaiTaiSan(long loaiTaiSanId);

	public List<LoaiTaiSan> findBase(
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public LoaiTaiSan getLoaiTaiSan(long loaiTaiSanId) throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<LoaiTaiSan> getLoaiTaiSans(int start, int end);
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public LoaiTaiSan updateLoaiTaiSan(LoaiTaiSan loaiTaiSan);

	public LoaiTaiSan updateLoaiTaiSan(
			LoaiTaiSan LoaiTaiSan, ServiceContext serviceContext)
		throws PortalException, SystemException, TrungMaException,
			   TrungSoCMNDException;
