...
/**
 * Provides the local service interface for MaSoTheoDoi. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see MaSoTheoDoiLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface MaSoTheoDoiLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link MaSoTheoDoiLocalServiceUtil} to access the ma so theo doi local service. Add custom service methods to <code>com.mb.service.impl.MaSoTheoDoiLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	public MaSoTheoDoi addMaSoTheoDoi(MaSoTheoDoi maSoTheoDoi);

	public MaSoTheoDoi addMaSoTheoDoi(
			MaSoTheoDoi maSoTheoDoi, ServiceContext serviceContext)
		throws PortalException, SystemException;

	public MaSoTheoDoi addOrUpdateMaSoThuChi(
			MaSoTheoDoi maSoTheoDoi, ServiceContext serviceContext)
	...
	public MaSoTheoDoi createMaSoTheoDoi(long maSoTheoDoiId);
	...
	public MaSoTheoDoi deleteMaSoTheoDoi(long maSoTheoDoiId)
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public MaSoTheoDoi deleteMaSoTheoDoi(MaSoTheoDoi maSoTheoDoi);
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public MaSoTheoDoi fetchMaSoTheoDoi(long maSoTheoDoiId);

	public List<MaSoTheoDoi> findBase(
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public MaSoTheoDoi getMaSoTheoDoi(long maSoTheoDoiId)
		throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<MaSoTheoDoi> getMaSoTheoDois(int start, int end);
	...
	public MaSoTheoDoi updateMaSoTheoDoi(
			MaSoTheoDoi maSoTheoDoi, ServiceContext serviceContext)
		throws PortalException, SystemException;
